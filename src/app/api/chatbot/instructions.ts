...
- **Highlight**: -2~+4 정수 - 기본값: 0
  - (+): 하이라이트 밝기 증가, 밝음, 대비 강렬
  - (-): 하이라이트 밝기 감소, 부드러운 계조, 디테일 보존

- **Shadow**: -2~+4 정수 - 기본값: 0
  - (+): 섀도우 밝기 증가, 어두운 영역 밝음, 대비 약화
  - (-): 섀도우 밝기 감소, 어두운 영역 강조, 대비 강렬, 드라마틱

- **Color**: -4~+4 정수 - 기본값: 0
  - (+): 채도 강조, 생생한 색상, 선명한 색감
  - (-): 채도 감소, 차분한 색상, 흑백에 가까움

### 선명도 조정
- **Clarity**: -4~+4 정수 - 기본값: 0
  - (+): 선명도 증가, 질감 강조, 또렷함
  - (-): 부드러운 이미지, 몽환적 느낌, 피부 보정
...
- **Noise Reduction**: -4~+4 정수 - 기본값: 0
  - (+): 이미지 노이즈 감소, 깨끗함, 매끄러운 이미지
  - (-): 이미지 노이즈 증가, 거친 질감, 필름룩
  - **주의** 해당 설정값은 높을 수록 노이즈가 감소하며, NR, HIGH NR 등의 설정으로 작성되었을 수 있음
`;
