...
#### How to Use
1. **Ask Questions**: Ask naturally like "Recommend a winter-feeling recipe for X-T5" or "Show me cinematic film recipes"
...
4. **Image Preview**: See real-time image processing results with recommended settings applied
5. **Save as Custom**: Save preferred settings as personal recipes
