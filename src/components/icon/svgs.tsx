...
export const SvgChatList = () => (
  <svg
    ...
    className="h-4 w-4"
  >
    <path d="M3.5 2.75a.75.75 0 0 0-1.5 0v14.5a.75.75 0 0 0 1.5 0v-4.392l1.657-.348a6.449 6.449 0 0 1 4.271.572 7.948 7.948 0 0 0 5.965.524l2.078-.64A.75.75 0 0 0 18 12.25v-8.5a.75.75 0 0 0-.928-.734l-2.072.64a6.47 6.47 0 0 1-4.571-.479A7.95 7.95 0 0 0 4.5 2.508l-.5.105a.75.75 0 0 0-.5.734v-.597Z" />
  </svg>
);

export const SvgModernPlus = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 20 20"
    fill="currentColor"
